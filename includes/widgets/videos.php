...
class Videos_Widget extends WP_Widget
{
	public function __construct()
	{
		$widget_ops = array(
			...
			'description'						=>	esc_html__('视频列表模式，一排3个。', 'text-alfie'),
			'customize_selective_refresh'		=>	true,
		);
		parent::__construct('video_widget', esc_html__('A 视频列表'), $widget_ops);
	}
	...
	public function widget($args, $instance)
	{
		...
		if ($query->have_posts()) :
			...
			echo '<div class="__videos" itemprop="ItemPage">';
...
?>
		...
		<p>
			...
			<?php
			$args = array(
				'show_option_all'	=>	esc_html__('选择分类', 'text-alfie'),
				'show_count'		=>	true,
				'hide_empty'		=>	false,
				'hierarchical'		=>	true,
				'class'				=>	'widefat',
